...
// ✅ Fix: Define the proper type with 'projects' included
interface Industry {
  icon: LucideIcon;
  title: string;
  description: string;
      ...
      <div className="max-w-[2000px] mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-300 max-w-3xl mx-auto">
            From real estate to public infrastructure, we provide specialized
            steel solutions across multiple industry verticals.
          </p>
        </div>
